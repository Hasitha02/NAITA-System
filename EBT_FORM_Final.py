...
app.title("EBT Registration Form")
...
header1 = ctk.CTkLabel(scrollable_frame, text="Student Registration Form - EBT", font=("Arial", 35, "bold"), text_color="black")
...
for field_key in ["category", "district", "dateOfRegistration", "indexNumber"]:
    ...
    if field_key == "category":
        ...
        entries[field_key].insert(0, "EBT - Enterprise Based Training")
