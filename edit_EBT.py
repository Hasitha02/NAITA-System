def edit_EBT_function():
    ...
    header_label_main = ctk.CTkLabel(header_frame_main, text="Edit Student Details - EBT", font=("Arial", 24, "bold"),
    ...
    header_label_edit = ctk.CTkLabel(header_frame_edit, text="Edit Student Details - EBT", font=("Arial", 24, "bold"),
                                     fg_color="white", text_color="black")
    ...
    # Create fields for each column in the EBTSD table using the headers mapping
    entry_fields = {}
