...
def form():
    ...
    # Section Header 1
    header1 = ctk.CTkLabel(section1_frame, text="Apprentice Details", font=("Arial", 29, "bold"),
    ...
    header_name = ctk.CTkLabel(section1_frame, text="Name", font=("Arial", 15, "bold"),
                           fg_color="#f0f0f0", text_color="black")
    header_name.grid(row=5, column=0, columnspan=2, pady=10, sticky="w")

    name = create_label_entry(section1_frame, 6, "Name", font_size=14)
    full_name = create_label_entry(section1_frame, 7, "Full Name", font_size=14)

    date_of_birth = DateEntry(section1_frame, width=12, background='darkblue', foreground='white', borderwidth=2,
                              font=("Arial", 14))
    date_of_birth.grid(row=8, column=1, padx=5, pady=5, sticky="w")

    # Gender Radio Buttons
    gender_label = ctk.CTkLabel(section1_frame, text="Gender", font=("Arial", 14), fg_color="#f0f0f0",
                                text_color="black", anchor="w")
    gender_label.grid(row=9, column=0, padx=5, pady=5, sticky="w")
